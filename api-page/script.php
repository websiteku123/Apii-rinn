<?php
// Mengatur header konten sebagai JavaScript agar tetap dapat diproses dengan benar oleh browser
header("Content-Type: application/javascript; charset=UTF-8");

// Mendapatkan tahun saat ini dari sisi server PHP
$currentYear = date("Y");
?>
            ...
            watermarkElement.innerHTML = `
                <div style="display: flex; flex-direction: column; align-items: center; gap: 10px; width: 100%; text-align: center;">
                    <p style="margin: 0; font-size: 14px; font-weight: 500; letter-spacing: 0.5px;">
                        <i class="fas fa-copyright" style="color: var(--primary-color);"></i> <?php echo $currentYear; ?> <strong>${creator}</strong>. All rights reserved.
                    </p>
