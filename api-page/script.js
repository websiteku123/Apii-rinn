            ...
            if (!routes.length) {
                ...
                Object.keys(categories).forEach((categoryName, catIndex) => {
                    ...
                    sortedItems.forEach((item, index) => {
                        ...
                        heroSection.style.padding = '12px 16px 48px 16px'; // Bottom padding ditambah buat space absolute button
                        ...
                        headerLayout.style.marginBottom = '4px'; // Di-presisi mepet biar deskripsi naik pol
                        ...
                        // 2. Baris Konten Bawah (Menggunakan flex-start biar nempel tanpa space kosong ganjel)
                        ...
                        itemDesc.style.margin = '0'; // Menghilangkan margin bawaan paragraf biar nempel ke atas
                        itemDesc.textContent = item.description || 'No description available for this endpoint.';

                        // Button GET Polos Murni Dikunci Absolute Di Pojok Kanan Bawah Card
