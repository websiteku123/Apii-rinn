            ...
            if (!routes.length) {
                ...
                Object.keys(categories).forEach((categoryName, catIndex) => {
                    ...
                    sortedItems.forEach((item, index) => {
                        ...
                        heroSection.style.borderRadius = '12px';
                        ...
                        heroSection.style.minHeight = '145px';
                        ...
                        headerLayout.style.paddingRight = '50px'; // Menyediakan space untuk status dot di kanan

                        // Badge Method (Kotak Hijau/Oranye di Kiri Atas)
                        ...
                        // Dot Status Hijau Aktif di POJOK KANAN ATAS Card (Sesuai Gambar Kiri)
                        const statusIndicator = document.createElement('div');
                        statusIndicator.style.position = 'absolute';
                        statusIndicator.style.top = '16px';
                        ...
                        // Deskripsi API menggantikan Path di Tengah Card
                        ...
                        // Footer Baris Tombol Aksi (Posisi Bawah Sesuai Gambar Kiri)
                        ...
                        // Button GET Persegi Panjang Minimalis
                        const getBtn = document.createElement('button');
                        getBtn.className = 'btn get-api-btn';
                        getBtn.innerHTML = '<i class="fas fa-link" style="font-size: 10px;"></i> GET';
