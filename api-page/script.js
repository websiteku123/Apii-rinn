...
sortedItems.forEach((item, index) => {
    ...
    itemCol.className = 'col-md-6 col-lg-4 api-item mb-4'; // Ditambah margin bottom sedikit biar lega
    ...
    heroSection.style.border = '1px solid rgba(255, 255, 255, 0.06)';
    heroSection.style.background = 'linear-gradient(135deg, rgba(255, 255, 255, 0.03) 0%, rgba(255, 255, 255, 0.01) 100%)';
    heroSection.style.backdropFilter = 'blur(12px)';
    heroSection.style.webkitBackdropFilter = 'blur(12px)';
    heroSection.style.height = '100%';
    heroSection.style.position = 'relative';
    heroSection.style.transition = 'transform 0.25s ease, border-color 0.25s ease, box-shadow 0.25s ease';
    heroSection.style.boxShadow = '0 4px 30px rgba(0, 0, 0, 0.2)';

    // Efek hover interaktif via JS (UI makin hidup dan responsif)
    heroSection.addEventListener('mouseenter', () => {
        heroSection.style.transform = 'translateY(-4px)';
        heroSection.style.borderColor = 'rgba(0, 200, 83, 0.3)';
        heroSection.style.boxShadow = '0 8px 30px rgba(0, 200, 83, 0.08)';
    });
    heroSection.addEventListener('mouseleave', () => {
        heroSection.style.transform = 'translateY(0)';
        heroSection.style.borderColor = 'rgba(255, 255, 255, 0.06)';
        heroSection.style.boxShadow = '0 4px 30px rgba(0, 0, 0, 0.2)';
    });

    // 1. Header Baris Utama (Method & Path)
    const headerLayout = document.createElement('div');
    headerLayout.style.display = 'flex';
    headerLayout.style.alignItems = 'center';
    headerLayout.style.gap = '10px';
    headerLayout.style.marginBottom = '16px';
    headerLayout.style.paddingRight = '75px'; // Jaga jarak aman dari status dot
    ...
    methodBadge.style.padding = '4px 10px';
    methodBadge.style.borderRadius = '6px';
    methodBadge.style.fontSize = '11px';
    methodBadge.style.fontWeight = '800';
    methodBadge.style.letterSpacing = '0.5px';
    methodBadge.style.border = `1px solid ${isGet ? 'rgba(0, 200, 83, 0.2)' : 'rgba(255, 145, 0, 0.2)'}`;

    const itemTitle = document.createElement('span');
    itemTitle.style.fontSize = '15px';
    itemTitle.style.fontWeight = '600';
    itemTitle.style.color = 'var(--text-color, #ffffff)';
    ...
    // Status Dot Aktif di Kanan Atas
    ...
    statusIndicator.style.background = 'rgba(0, 200, 83, 0.06)';
    statusIndicator.style.padding = '3px 8px';
    statusIndicator.style.borderRadius = '20px';
    statusIndicator.style.border = '1px solid rgba(0, 200, 83, 0.15)';

    const icon = document.createElement('i');
    icon.className = 'fas fa-circle';
    icon.style.color = '#00c853'; 
    icon.style.fontSize = '7px';
    // Beri efek pulsasi halus pada dot status aktif
    ...
    // 2. Layout Konten Utama Bawah (Menggunakan flex column vertikal)
    ...
    contentLayout.style.flex = '1'; // Memaksa konten mengisi space sisa card agar tinggi tombol sejajar
    contentLayout.style.width = '100%';

    // Deskripsi ditaruh di atas
    ...
    itemDesc.style.marginBottom = '18px'; // Memberikan jarak presisi sebelum masuk ke tombol
    itemDesc.textContent = item.description || 'No description available for this endpoint.';

    // Container pembungkus tombol agar posisinya berada penuh di paling bawah
    const btnContainer = document.createElement('div');
    btnContainer.style.width = '100%';
    btnContainer.style.marginTop = 'auto'; // Auto push ke area terbawah card

    // Tombol GET Elegan Full Width
    const getBtn = document.createElement('button');
    getBtn.className = 'btn get-api-btn';
    getBtn.innerHTML = '<i class="fas fa-terminal" style="font-size: 11px;"></i> GET';
    ...
    getBtn.style.padding = '8px 16px';
    getBtn.style.borderRadius = '8px'; 
    getBtn.style.fontSize = '12px';
    getBtn.style.fontWeight = '600';
    getBtn.style.height = '36px';
    getBtn.style.width = '100%'; // Dibuat full width biar layoutnya kokoh dan rapi di bawah teks
    getBtn.style.display = 'inline-flex';
    getBtn.style.alignItems = 'center';
    getBtn.style.justifyContent = 'center';
    getBtn.style.gap = '8px';
    getBtn.style.background = 'rgba(0, 200, 83, 0.08)';
    getBtn.style.color = '#00c853';
    getBtn.style.border = '1px solid rgba(0, 200, 83, 0.2)';
    getBtn.style.transition = 'all 0.2s ease';
    getBtn.style.letterSpacing = '0.5px';

    // Hover effect untuk internal get button style
    getBtn.addEventListener('mouseenter', () => {
        getBtn.style.background = 'rgba(0, 200, 83, 0.16)';
        getBtn.style.borderColor = 'rgba(0, 200, 83, 0.4)';
    });
    getBtn.addEventListener('mouseleave', () => {
        getBtn.style.background = 'rgba(0, 200, 83, 0.08)';
        getBtn.style.borderColor = 'rgba(0, 200, 83, 0.2)';
    });
    ...
    contentLayout.appendChild(btnContainer);
...
// ... [Sisa kode fungsi modal & handler di bawahnya tetap sama] ...
        ...
        document.addEventListener('click', event => {
            ...
            // FIX: Jangan bersihkan innerHTML text parameter/deskripsi bawaan di sini agar tidak hilang/blank saat diproses
