document.addEventListener('DOMContentLoaded', async () => {
    ...
    // FIX BENTROK: Cek eksistensi element terlebih dahulu sebelum pasang event listener agar tidak crash
    if (navCollapseBtn) {
...
// ==========================================
// BAGIAN TEXT GENERATOR FOOTER & DESKRIPSI (FIXED)
// ==========================================
...
// 1. MODIFIKASI DESKRIPSI UTAMA: Diganti menjadi deskripsi sistem yang sangat lengkap
...
// 2. MODIFIKASI WATERMARK/COPYRIGHT: Mengatur element wm agar tersusun full icon fas fa yang rapi
...
if (watermarkElement) {
    ...
    `;
        ...
        // FIX PERINTAH: Menghapus total bagian tombol github dari container apiLinks
...
// ==========================================
// BAGIAN GENERATE LIST API ENDPOINT (ROW MINIMALIS)
// ==========================================
sortedItems.forEach((item, index) => {
    const itemCol = document.createElement('div');
    // Menggunakan col-12 agar layoutnya memanjang horizontal dari kiri ke kanan
    itemCol.className = 'col-12 api-item mb-2'; 
    ...
    // Wrapper utama berupa baris horizontal tipis (Row-style)
    ...
    heroSection.style.padding = '12px 16px';
    heroSection.style.gap = '15px';
    heroSection.style.width = '100%';
    heroSection.style.minHeight = 'auto'; // Mengurangi tinggi card agar tidak memakan tempat

    // Container text kiri (Method, Path, dan Deskripsi secara berurutan)
    const infoDiv = document.createElement('div');
    infoDiv.className = 'info-text-container';
    infoDiv.style.flex = '1';
    infoDiv.style.display = 'flex';
    infoDiv.style.flexDirection = 'column';
    infoDiv.style.gap = '4px';

    // Gabungkan Method & Path ke dalam satu baris ringkas
    const itemTitle = document.createElement('h6');
    itemTitle.className = 'mb-0';
    itemTitle.style.fontSize = '15px';
    itemTitle.style.fontWeight = '600';
    
    const methodColor = item.method.toUpperCase() === 'GET' ? '#00c853' : '#ff9100';
    itemTitle.innerHTML = `<span style="color: ${methodColor}; font-weight: bold; margin-right: 6px;">${item.method}</span><span style="color: var(--text-color);">${item.path}</span>`;

    // Deskripsi ditaruh tepat di bawah nama endpoint secara rapat
    ...
    // Container aksi kanan (Menyatukan Dot Status & Button Persegi Panjang)
    const actionsDiv = document.createElement('div');
    actionsDiv.className = 'api-actions';
    actionsDiv.style.display = 'flex';
    actionsDiv.style.alignItems = 'center';
    actionsDiv.style.gap = '16px';
    actionsDiv.style.flexShrink = '0'; // Mencegah button menyusut

    // Dot Status Aktif Hijau Minimalis
    ...
    icon.style.color = '#00c853'; // Tetap dipaksa hijau aktif
    ...
    // Button dibuat Persegi Panjang Minimalis
    const getBtn = document.createElement('button');
    getBtn.className = 'btn get-api-btn';
    getBtn.innerHTML = '<i class="fas fa-terminal" style="font-size: 11px;"></i> TEST';
    ...
    // Memberikan style kustom langsung via JS untuk memastikan bentuk persegi panjang slim
    getBtn.style.padding = '5px 14px';
    getBtn.style.borderRadius = '4px'; // Sudut tegas berbentuk persegi panjang
    getBtn.style.fontSize = '12px';
    getBtn.style.fontWeight = '600';
    getBtn.style.height = '32px';
    getBtn.style.lineHeight = '1';
    getBtn.style.display = 'inline-flex';
    getBtn.style.alignItems = 'center';
    getBtn.style.gap = '6px';

    // Susun semua komponen masuk ke dalam list row
