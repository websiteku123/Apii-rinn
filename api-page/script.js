...
// ... [Kode bagian atas tetap sama sampai bagian dynamic render routes] ...
...
sortedItems.forEach((item, index) => {
    ...
    heroSection.style.padding = '18px 20px';
    ...
    headerLayout.style.marginBottom = '14px';
    headerLayout.style.paddingRight = '70px'; // Space aman untuk status dot di kanan
    ...
    methodBadge.style.fontSize = '12px';
    ...
    // Dot Status Hijau Aktif di Pojok Kanan Atas
    const statusIndicator = document.createElement('div');
    statusIndicator.style.position = 'absolute';
    statusIndicator.style.top = '18px';
    ...
    // 2. Baris Konten Tengah (Deskripsi + Button GET Sejajar di Samping)
    ...
    // Button GET Persegi Panjang Elegan (Naik ke atas samping teks)
    ...
    // Menggunakan nama kategori atau fallback path tanpa tanda "/" sebagai title clean di modal nanti
    ...
    getBtn.style.padding = '6px 16px';
    getBtn.style.borderRadius = '6px'; 
    ...
    // Gabungkan komponen ke dalam flex row tengah
    contentLayout.appendChild(itemDesc);
    contentLayout.appendChild(getBtn);

    // Masukkan ke main container card
