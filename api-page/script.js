            ...
            if (!routes.length) {
                ...
                Object.keys(categories).forEach((categoryName, catIndex) => {
                    ...
                    sortedItems.forEach((item, index) => {
                        ...
                        // 2. Baris Konten Bawah (Deskripsi di atas, Button dipaksa ke pojok kanan bawah)
                        ...
                        // Button GET Tanpa Icon & Dikunci di Pojok Kanan Bawah
                        ...
                        getBtn.style.alignSelf = 'flex-end'; 
