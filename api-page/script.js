document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
    // FIX: Nembak langsung lewat proxy domain panel utama yang sudah ber-SSL HTTPS aman
    const response = await fetch('https://pedia.panelcloud.web.id:4000/openapi.json');
        if (!response.ok) {
